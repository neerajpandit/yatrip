...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://yatripbackend.onrender.com/signup/', formData);
  ...
  return (
    <div>        
      <div className="bg-white relative lg:py-20">
        ...
        <p className="text-4xl font-medium text-right leading-snug font-serif">If you have already an account ! <a href="/Login" className="  text-4xl font-medium text-center text-white bg-indigo-500 rounded-lg transition duration-200 hover:bg-indigo-600 ease">Login</a> </p>
       
        <div className="flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl xl:px-5 lg:flex-row">
          <div className="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
            <div className="w-full bg-cover relative max-w-md lg:max-w-2xl lg:w-7/12">
              <div className="flex flex-col items-center justify-center w-full h-full relative lg:pr-10">
                <img src="https://res.cloudinary.com/macxenon/image/upload/v1631570592/Run_-_Health_qcghbu.png" alt="Run Health" className="btn-" />
              </div>
            </div>
            <div className="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
              ...
              <div className="relative mt-6">
                <a href="/Login" className="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500 rounded-lg transition duration-200 hover:bg-indigo-600 ease">Login</a>
              </div>
            </div>
          </div>
        </div>
...
// <div className="bg-white relative lg:py-20">
// <p className="text-4xl font-medium text-right leading-snug font-serif">If you have already an account ! <a href="/Login" className="  text-4xl font-medium text-center text-white bg-indigo-500
//                   rounded-lg transition duration-200 hover:bg-indigo-600 ease">Login</a> </p>
...
//          <p className="text-4xl font-medium text-center leading-snug font-serif">OR</p>
//          <div className="relative mt-6">
//               <a href="/Login" className="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500
